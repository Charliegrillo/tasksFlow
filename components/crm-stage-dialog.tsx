      ...
      <div onClick={e => e.stopPropagation()} className="w-full max-w-sm rounded-sm border border-border bg-card p-6 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input value={name} onChange={e => setName(e.target.value)} className="w-full rounded-sm border border-border bg-background px-3 py-2 text-sm outline-none focus:border-primary" placeholder="Nombre de la etapa" autoFocus />
          </div>
          <div className="flex flex-col gap-1.5">
